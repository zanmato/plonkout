...
describe("Statistics.vue", () => {
  ...
  const mockWorkouts = [
    {
      ...
      exercises: [
        ...
        {
          name: "Hook Training",
          sets: [{ type: "regular", weight: 25, reps: 6 }],
        },
      ],
    },
    {
      ...
      exercises: [
        {
          name: "Wrist Curl",
          sets: [{ type: "regular", weight: 23, reps: 9 }],
        },
        {
          name: "Side Pressure",
          sets: [
  ...
  describe("Statistics Calculations", () => {
    ...
    it("generates workouts per month data", () => {
      ...
      expect(monthlyData.datasets[0].data).toEqual(
    ...
    it("generates most used exercises data", () => {
      ...
      expect(exerciseData.datasets[0].data).toEqual(
