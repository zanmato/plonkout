...
/** Only the set and exercise fields getSetNumber reads, fixtures also use null/undefined arms */
interface NumberedSet {
  type: string
  arm?: string | null
}

interface NumberedExercise {
  name: string
  singleArm?: boolean
}
 ...
 */
function getSetNumber(sets: NumberedSet[], setIndex: number, exercise: NumberedExercise, currentSet: NumberedSet) {
