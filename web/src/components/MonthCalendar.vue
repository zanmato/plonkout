...
type CalendarDay =
  | { type: 'empty'; day?: undefined; hasWorkout?: undefined }
  | { type: 'day'; day: number; hasWorkout: boolean };

type CalendarRow =
  | { type: 'header'; days: string[] }
  | { type: 'week'; days: CalendarDay[] };
 ...
 */
const calendarData = computed<CalendarRow[]>(() => {
